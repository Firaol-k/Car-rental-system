...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Here we have diffent cars from all sort. you can get BMW, TOYOTA, MERCEDES, MARUTI, NISSAN, AUDI and other lexuries and common cars for your day to day activities or for special events like wedding. We have a fast customer support service. To rent any car all you need to do is get the detail of the car by clicking on the picture of the car and fill the booking form. Your booking will be confirmed with in a minutes</p>
    </div>
    <div class="row"> 
...
<?php }}?>
 ...
 <a href="car-listing.php" class="btn" style="margin-top: 25px, ">See more <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
</section>
<!-- /Resent Cat --> 
